...
- [ ] 글자 단위 낱 표시 기능 추가
  - [ ] 입력한 글자: 칠해짐 (배경색 표시)
  - [ ] 앞으로 입력할 글자: 회색으로 표시
  - [ ] renderTextWithFeedback에서 각 글자의 입력 여부 판단
  - [ ] 커서 위치에 따라 동적으로 낱 표시 업데이트


# 기능 개선 (v1.19) - 완료
- [x] 글자 단위 배경색 표시 기능 추가
  - [x] 입력한 글자: 초록색 배경 (bg-green-100)
  - [x] 앞으로 입력할 글자: 회색 배경 (bg-gray-200)
  - [x] 틀린 글자: 빨강색 배경 (bg-red-100)
  - [x] 부분 일치: 노랑색 배경 (bg-yellow-100)
  - [x] 커서 위치에 따라 동적으로 배경색 업데이트됨 확인
